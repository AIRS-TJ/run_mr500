...
//			m_oLog("[TCPServer][Error] CTCPClient::SetRcvTimeout : Socket error in SO_RCVTIMEO call to setsockopt.");
		std::cout<<"[TCPServer][Error] CTCPClient::SetRcvTimeout : Socket error in SO_RCVTIMEO call to setsockopt."<<std::endl;
...
//			m_oLog("[TCPServer][Error] CTCPClient::SetSndTimeout : Socket error in SO_SNDTIMEO call to setsockopt.");
		std::cout<<"[TCPServer][Error] CTCPClient::SetSndTimeout : Socket error in SO_SNDTIMEO call to setsockopt."<<std::endl;
...
//         m_oLog("[TCPClient][Warning] Opening a new connexion. The last one was automatically closed.");
		std::cout<<"[TCPClient][Warning] Opening a new connexion. The last one was automatically closed."<<std::endl;
   }
...
//         m_oLog(StringFormat("[TCPClient][Error] getaddrinfo failed : %d", iResult));
		std::cout<<"[TCPClient][Error] getaddrinfo failed."<<std::endl;
...
//         m_oLog(StringFormat("[TCPClient][Error] socket failed : %d", WSAGetLastError()));
		std::cout<<"[TCPClient][Error] socket failed."<<std::endl;
...
//         m_oLog("[TCPClient][Error] Socket error in call to setsockopt");
		std::cout<<"[TCPClient][Error] Socket error in call to setsockopt."<<std::endl;
...
//      m_oLog(StringFormat("[TCPClient][Error] Unable to connect to server : %d", WSAGetLastError()));
	 std::cout<<"[TCPClient][Error] Unable to connect to server."<<std::endl;
...
//      m_oLog("[TCPClient][Error] no such host.");
	 std::cout<<"[TCPClient][Error] no such host."<<std::endl;
...
//         m_oLog("[TCPClient][Error] send failed : not connected to a server.");
		std::cout<<"[TCPClient][Error] send failed : not connected to a server."<<std::endl;
...
//         m_oLog("[TCPClient][Error] recv failed : not connected to a server.");
		std::cout<<"[TCPClient][Error] recv failed : not connected to a server."<<std::endl;
...
//            m_oLog("[TCPClient][Error] Socket error in call to recv.");
		   std::cout<<"[TCPClient][Error] Socket error in call to recv."<<std::endl;
...
//         m_oLog(StringFormat("[TCPClient][Error] shutdown failed : %d", WSAGetLastError()));
	    std::cout<<"[TCPClient][Error] shutdown failed."<<std::endl;
